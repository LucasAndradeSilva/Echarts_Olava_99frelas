...
antesDeOntem.setDate( antesDeOntem.getDate() - 1);
...
function consultarSistema(dispositivoToSearch,dataInicio,dataFim,dispositivoASerUsado){
    ...
    MongoClient.connect('mongodb://olavo.rocha.k:garymu261990@localhost:27017/digi?authSource=admin', function (err, client) {
